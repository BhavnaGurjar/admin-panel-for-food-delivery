...
export const ticketData = [
  {
    ...
    ticketId: "12347",
    icon: <Icons.Location />,
    statusMessage: "Delivery Partner Unavailable",
    inputLabel: "Message",
  ...
  },
  {
    ...
    ticketId: "12348",
    icon: <Icons.Location />,
    statusMessage: "Partner missed calls",
    inputLabel: "Message",
    inputPlaceholder: "Enter Message",
    acceptReason: null,
    rejectReason: null,
  ...
  export const stages = [
    {
      ...
      total: 10,
      subStages: [
        { name: "In Cancellation", count: 10 },
        { name: "Awating", count: 10 },
      ...
      subStages: [
        ...
        { name: "Delay", count: 0 },
        {
          ...
          subStages: [
            ...
            { name: "Auto Cancelled", count: 0 },
          ],
        },
        { name: "Preparing", count: 0 },
        { name: "Ready", count: 0 },
        { name: "Pickedup", count: 0 },
