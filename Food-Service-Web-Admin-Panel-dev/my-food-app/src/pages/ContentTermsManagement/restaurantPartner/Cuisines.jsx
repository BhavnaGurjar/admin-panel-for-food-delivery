...
const Cuisines = () => {
  ...
  return (
    <div className="p-4">
      <h4 className="mb-4 text-dark fw-bold">Cuisines</h4>

      <Card className="border rounded" style={{ borderColor: "#0000001A" }}>
        <Card.Body>
          {/* Header Section */}
          <div className="flex justify-between items-center mb-3">
            <h5 className="fw-bold mb-0">Cuisine list</h5>
          ...
          >
            ...
            <div
              style={{ color: "#5F5E5E" }}
              className="flex pt-4 px-3 mb-3 fw-semibold"
            >
              <div className="col-3">Name</div>
              <div className="col-3">Created At</div>
              <div className="col-2">Active Users</div>
            ...
            {tags.map((cat, index) => (
              ...
              >
                <div className="col-12 col-md-3 mb-2 fw-semibold mb-md-0">
                  {cat.name}
                </div>
                <div className="col-12 col-md-3 fw-semibold mb-2 mb-md-0">
                  {cat.createdAt}
                </div>
                <div className="col-12 col-md-2 fw-semibold mb-2 mb-md-0">
                  {cat.activeUsers}
                </div>
      ...
      {isAddOpen && (
        <Modal show={true} onHide={handleCloseAdd} centered>
          <Modal.Header className="border-0" closeButton>
            <Modal.Title className="">Add New Cuisine</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form>
              <Form.Group controlId="cuisineName">
                <Form.Label className="fw-semibold">Cuisine Name</Form.Label>
                <Form.Control
                  className="py-3"
                  type="text"
          ...
          <Modal.Footer className="flex flex-row border-0 justify-between">
            <Button
              variant="light"
